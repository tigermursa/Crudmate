    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
      {users?.map((user: user) => {
        ...
        return (
          <div
            key={user?.uid}
            className="bg-teal-600 p-4 rounded-lg shadow-xl shadow-black relative hover:shadow-lg transition-shadow border-2 border-teal-200 w-[220px] lg:w-[300px] sour-gummy"
          >
            {/* Avatar */}
            <div className="flex flex-col items-center mb-4">
              ...
              <h4 className="text-lg sm:text-xl md:text-2xl font-extrabold text-gray-50">
